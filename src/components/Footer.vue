  ...
  <footer class="bg-gray-900 text-white py-12">
    <div class="max-w-7xl mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h3 class="text-xl font-bold text-yellow-500 mb-4">АрхТехПроект</h3>
          <p class="text-gray-400">Проектно-строительная компания с многолетним опытом работы</p>
        </div>
        <div>
        ...
        <div>
          ...
          <div class="space-y-2 text-gray-400">
            <p>398024, г. Липецк,</p>
            <p>ул. Доватора 14 офис 311</p>
            <p>Тел: +7 (920) 512-10-32</p>
            <p>E-mail: ivs15@rambler.ru</p>
            <p>arhteh@inbox.ru</p>
          </div>
        </div>
        <div>
